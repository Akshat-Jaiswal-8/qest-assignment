...
export const faqs: IFaqs[] = [
  ...
  },
  {
    ...
    answer: 'You can try Qest for free for 30 days. After the trial expires, you can choose a pricing plan that suits the size and stage of the business. Our basic plan starts from 1200/business location/month. We also have add-ons that can be added or removed based your need.\n',
  },
